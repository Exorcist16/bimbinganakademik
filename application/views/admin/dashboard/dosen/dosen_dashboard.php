            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-xs-6">
                ...
                <div class="small-box bg-green">
                  ...
                  <a href="<?= base_url() ?>dosen/pembimbing" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- ./col -->
              ...
              <div class="col-lg-6 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                  ...
                  <a href="<?= base_url() ?>dosen/penguji" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- ./col -->
            </div>
